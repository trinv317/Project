...
public class AddToOrderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check=dao.insert(new OrderDTO(0,userID, idGlasses, Type, Quantity, MethodPayment, totalPrice, Date));
            if(check){
                url=SUCCESS;
                session.setAttribute("MESSAGE", "Your order added successfully ");
            }
        } catch (Exception e) {
            log("Error at AddToOrderController: " + e.toString());
        } finally {
