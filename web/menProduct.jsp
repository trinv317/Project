<%-- 
    Document   : menproduct
    Created on : Mar 26, 2025, 8:34:38 AM
    Author     : TGDD
--%>
...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2" href="producthome.jsp">Account</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container mt-4 width">
            <div class="row">
                <div class="col-3 margin-top border" style="height: 300px">
                ...
                <div class="col-9">
                    ...
                    <div class="pagination">
                        <li class="pageitem previous-page disable"><a href="#" class="page-link">Pres</a></li>
        ...
        <div class="container mt-4 width">
            <div class="row">
                <div class="col-3 margin-top border" style="height: 350px">
                    ...
                    <div class="row">
                        <%
                            for (ProductDTO product : listAll) {
                                if (product.getType().equals("Male")) {
                        %>
